<%-- 
    Document   : Contact3
    Created on : 06-Apr-2024, 5:28:40 pm
    Author     : Sneha
--%>
...
<head>
    ...
    <style>
        ...
        #sendMail:hover {
            background-color: #40693F; /* Change background color on hover */
        }
        body{
...
function openMail() {
    ...
    if (checkedMessageIDs.length > 0) {
        window.location.href = 'viewMail3.jsp?mailID=' + checkedMessageIDs[0]; // Assuming only one mail can be opened at a time
    } else {
...
function storeCheckedMessageIDs() {
    ...
    // Redirect to viewMail.jsp with the selected message_id
        ...
        window.location.href = 'viewMail3.jsp?mailID=' + mailID;
        }
...
%>
    ...
    <div class="sec2">
        ...
        <form id="formMail" method="post" action="SendMail3.jsp">
            <input type="hidden" name="sender_type" value="user">
            <input type="hidden" name="sender_id" value="<%=adminID%>"><br><br>
