<%-- 
    ...
    Created on : 04-Apr-2024, 5:39:25 am
    Author     : Sneha
--%>

<%-- 
    Document   : AgentProfile
    Created on : 02-Apr-2024, 3:14:11 am
    Author     : Sneha
--%>
...
<%
    ...
    try {
        ...
        String sql = "SELECT username, password, email FROM ADMIN WHERE adminID = ?";
        pstmt = conn.prepareStatement(sql);
        pstmt.setString(1, (String) session.getAttribute("adminID"));
...
<html>
    <head>
      ...
      .title{
        ...
        #EditProfile {
            background-color: #40693F; /* Green background color */
        ...
        #editProfileForm button[type="submit"] {
            background-color: #00BD62; /* Green background color */
            color: white; /* White text color */
    ...
    function signOut() {
        ...
        window.location.href = "Logout.jsp?accountID=<%= adminID %>";
    }
    ...
    <div class="profile-info">
     ...
     <button id="EditProfile" onclick="showEditForm()"> Edit </button>
        ...
        <div id="editForm" style="display: none;">
            <form id="editProfileForm" action="UpdateAdminProfile.jsp" method="POST">
