...
<%
    ...
    try {
        ...
        pstmt.setString(1, (String) session.getAttribute("agentID"));
...
<html>
    <head>
      ...
      .title{
        ...
        #EditProfile {
            background-color: #187A7D; /* Green background color */
    ...
    function signOut() {
        ...
        window.location.href = "Logout.jsp?accountID=<%= agentID %>";
    }
    ...
    <body>
        <div class="title">
            ...
            <div class="profile">Agent Profile</div>
...
<button id="EditProfile" onclick="showEditForm()"> Edit </button>
        ...
        <div id="editForm" style="display: none;">
            <form id="editProfileForm" action="UpdateAgentProfile.jsp" method="POST">
