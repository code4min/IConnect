<%-- 
    Document   : ViewTicketAdmin
    Created on : 02-Apr-2024, 4:01:04 pm
    Author     : Sneha
--%>
...
<body>
    <div class="titlebar">
            ...
            <div class="ticketContainer" id="ticketContainer">
                    ...
                    <p><strong>Due Date :</strong> <%= rs.getString("due_date") %></p>
                    <p><strong>Open Date & Time :</strong> <%= rs.getString("Open_DateTime") %></p>
