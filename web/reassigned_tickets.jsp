<%-- 
    Document   : reassigned_tickets
    Created on : 02-Apr-2024, 9:56:35 pm
    Author     : Sneha
--%>
...
<html>
  ...
  .low-priority {
    ...
    <body>
        ...
        <div class="resolved">Reassigned Tickets</div>
    </div>
...
<%
    ...
    try{
        ...
        pstmt = conn.prepareStatement("SELECT t.tID,t.tType,t.TicketStatus,t.Priority, t.subject,u.username AS createdBy, a.username AS assignedTo FROM TICKET t JOIN USERS u ON t.uID = u.userID JOIN AGENTS a ON t.Agent = a.agentID WHERE t.TicketStatus = 'reassigned' ORDER BY tID DESC ");
